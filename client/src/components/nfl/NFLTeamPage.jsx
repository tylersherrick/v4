...
import NFLTeamLeaders from "./NFLTeamLeaders.jsx";
import NFLTeamRoster from "./NFLTeamRoster.jsx";
import NFLTeamSchedule from "./NFLTeamSchedule.jsx";
...
export default function NFLTeamPage() {
  ...
  if (searchParams.get("seasonType")) {
    gamesParams.set(
      "seasonType",
  ...
  return (
    <main className="cfb-team-page">
      ...
      {activeTab === "schedule" && (
        <NFLTeamSchedule teamId={teamId} />
      )}

      {activeTab === "roster" && (
        <NFLTeamRoster teamId={teamId} />
      )}

      {activeTab === "leaders" && (
        <NFLTeamLeaders teamId={teamId} />
      )}
    </main>
  );
}